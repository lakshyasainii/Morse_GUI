...
text_box.grid(row=4, column=2, padx=16, pady=12)

    
press = Button(win, text="PRESS_ENTER_KEY", command=press_enter, bg='green3',fg='white', font='Arial', height=2, width = 8)
press.grid(row=2, column=3, padx=12, pady=6)
